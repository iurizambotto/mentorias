...
```bash
cd ~/zambotto_new/projects/zambotto-mentoria/infrastructure/sessao-02-orquestracao-airflow
```
...
```bash
cd ~/zambotto_new/projects/zambotto-mentoria/infrastructure/sessao-02-03-airflow-cdc-tabelas
