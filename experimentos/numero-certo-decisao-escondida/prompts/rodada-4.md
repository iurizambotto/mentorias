...
| | |
|---|---|
| Camada acrescentada | Instruções de desconfiança: contar as linhas, checar contagem dupla e divisão por zero, mostrar o código. |
| Hipótese registrada antes de rodar | O modelo deduplica e chega perto de 101,3%, com o código à vista. |
| O que aconteceu | As três ficaram entre 100,8% e 101,3%, e todas declararam a decisão sobre sobreposição. |
