---
title: "Subir o ambiente no Linux"
date: 2026-07-30
type: runbook
status: active
tags: [cdc, docker, linux, mentoria]
---
...
## 1) Subir Airflow base ()

A partir da raiz do repositorio clonado (`mentorias/`), navegue ate a infra do Airflow:
